...
expensive model on the board scored *worse* while costing _33 times_ as much.
...
Nearly everyone scored _4 out of 10_. The frontier models - Fable 5, GPT-5.5, both
Opus generations - did not beat Sonnet 4.6 or gpt-4o-mini. Fable 5 cost _33 times_ what
gpt-4o-mini did for the identical score. That's not the shape you expect when you line up
...
## What the numbers say that benchmarks don't

Token count is a terrible efficiency proxy. gpt-4o-mini burned _476,000 tokens_ -
...
Fable 5 each emitted roughly _twice_ the output tokens of Haiku and Sonnet on the same
diagnosis prompts (25-30K versus 12-14K). All that extra deliberation converted _zero_
...
_seven of nine_ landed identical scores both times (0.000 spread), it still
...
it. That's the one that took me longer to accept. My cost axis was trustworthy the whole time - dollars are dollars. My *quality*

...
Prompted by a [Nate B. Jones](https://www.youtube.com/@natebjonestech) video on preparing for model upgrades, this session builds a proper evaluation harness for the multi-agent infrastructure pipeline.
